...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{ asset('/resources/assets/doc_file/bootstrap-datepicker.min.css')}}">
  <!-- Daterange picker -->
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong></span> &copy; AmuJamu.com theme Developed by Prochito Information Technology Soluation (TIS).</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- datepicker -->
<script src="{{ asset('/resources/assets/doc_file/bootstrap-datepicker.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
