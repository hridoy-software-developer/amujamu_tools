...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('/resources/assets/doc_file/blue.css')}}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>AmuJmau</b>Tools</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="{{ URL::route('Dashboard.check') }}" method="post">
    {{ csrf_field() }}
...
<!-- iCheck -->
<script src="{{ asset('/resources/assets/doc_file/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
